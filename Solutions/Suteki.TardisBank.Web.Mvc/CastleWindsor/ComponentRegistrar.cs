namespace Suteki.TardisBank.Web.Mvc.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddTasksTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("Suteki.TardisBank.Tasks")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("Suteki.TardisBank.Domain"));
        }
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container) 
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("Suteki.TardisBank.Infrastructure")
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("Suteki.TardisBank.Tasks")
